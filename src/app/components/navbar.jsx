...
export default function Navbar() {
  ...
  const socialLinks = [
    { name: "GitHub", path: "https://github.com/Abdullahakmal238", icon: <Github size={18} /> },
    { name: "LinkedIn", path: "https://www.linkedin.com/in/abdullahakmal238/", icon: <Linkedin size={18} /> },
    { name: "Email", path: "mailto:abdullahakmal238@gmail.com", icon: <Mail size={18} /> },
  ];
