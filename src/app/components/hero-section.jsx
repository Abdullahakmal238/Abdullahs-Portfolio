    ...
    <section className="container mx-auto flex flex-col md:flex-row items-center md:items-start gap-8 lg:gap-20 px-4 lg:px-20 mt-6">
      ...
      >
        ...
        <p className="mt-3 max-w-xl text-lg sm:text-base italic">
          ...
          React.js, Node.js, Express.js, MongoDB, and Firebase, I craft
          intuitive UIs with Bootstrap while developing secure, efficient
          backends. Curious about modern UI/UX and performance optimization, I
          aim to contribute by delivering clean, impactful solutions and
